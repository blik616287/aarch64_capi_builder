#!/bin/bash
#
# Image Validation Script - Runs on c7g.metal ARM64 instance
#
...
QCOW2_IMAGE=$(ls "$OUTPUT_DIR"/*.qcow2 2>/dev/null | head -1)
...
EOF
    ...
    # Copy EFI vars
    cp /usr/share/AAVMF/AAVMF_VARS.fd ./efivars.fd
